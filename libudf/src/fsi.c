...
void set_mesh_positions(Domain* domain)
{
    ...
    precicec_setMeshVertices(nodeMeshName, wet_nodes_size, initial_coords, displ_indices);
    precicec_setMeshVertices(faceMeshName, wet_face_size, face_coords, face_indices);
